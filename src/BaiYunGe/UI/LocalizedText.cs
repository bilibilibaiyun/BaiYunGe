...
public sealed class LocalizedText
{
    private static readonly Dictionary<string, (string Zh, string En)> Table = new()
    {
        ...
        ["Calibration.Prompt"] = ("点击确定后，请用你最舒适的音量，不停重复说「你好」，直到采样结束。", "After clicking OK, keep repeating \"hello\" at your most comfortable volume until sampling ends."),
        ["Calibration.Recording"] = ("正在录音采样…\n请不停重复说「你好」", "Recording…\nKeep repeating \"hello\""),
        ...
        ["Dict.RecordAdd"] = ("录音添加", "Record & Add"),
        ["Dict.Next"] = ("下一步", "Next"),
        ["Dict.StartRecord"] = ("开始录音", "Start Recording"),
        ["Dict.RecordingNow"] = ("录音中…", "Recording…"),
        ["Dict.RecordPrompt"] = ("请念出「{0}」这个词", "Please say the word \"{0}\""),
        ...
        ["Update.SelectVersion"] = ("选择版本…", "Select version…"),
        ["Update.SelectHint"] = ("选择一个要安装的版本：", "Select a version to install:"),
        ["Update.SelectAction"] = ("选择此版本", "Select this version"),
        ["Update.InstallConfirm"] = ("将安装 v{0}，点击下方「安装」按钮继续。", "v{0} will be installed. Click \"Install\" to continue."),
        ["Update.InstallNow"] = ("安装", "Install"),
        ["Update.TestRisk"] = ("⚠️ 该版本为测试版，可能有缺陷，建议优先选择稳定版。", "⚠️ This is a testing version and may have defects. A stable version is recommended."),
        ["Update.UacHint"] = ("安装即将开始，随后可能弹出 Windows 用户账户控制（UAC）窗口，请点击「是」完成安装。", "Installation will begin. If a Windows UAC prompt appears, click \"Yes\" to complete."),
